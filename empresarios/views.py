...
def empresa(request, id):
    ...
    if request.method == "GET":
        ...
        return render(request, 'empresa.html', {'empresa': empresa, 'documentos': documentos, 'proposta_investimentos_enviada': proposta_investimentos_enviada, 'percentual_vendido': int(percentual_vendido), 'valuation_atual': valuation_atual, 'total_captado': total_captado})
